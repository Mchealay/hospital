...
<head>
    <title>contact with shire referral hospital</title>
...
<body>
    ...
    <nav style="width: 100%;" class="bg-dark">
        <div class="btn-group ">
            ...
            <a href="appointments.php" title="this is appointment session"
                class="btn btn-secondary">Appointment-Session</a>

            <a href="contactus.php" title="this is contact us (communication method)"
                class="btn btn-secondary active">Contact</a>
    ...
    <nav style="margin-left:40px;">
        ...
        <p> Phone no: 0963388830 </p>

        <p> Email: Dani@gmail.com </p>
        <p>Email: Asgedomhaile@gmail.com</p>
